...
namespace Globals
{
    ...
    /// Constants
    /// </summary>
    public static class GlobalSystemConstants
    {

        public const string TARG_ROUTE_EXPR = "highway";
        ...
        public const string XML_WAY_ELEMENT_NAME = "way";

        public const string XML_NODE_ELEMENT_NAME = "node";
